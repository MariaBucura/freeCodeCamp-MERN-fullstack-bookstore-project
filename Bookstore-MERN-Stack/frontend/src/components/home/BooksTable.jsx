        ...
        <table className='w-full border-separate border-spacing-2'>
                        <thead>
                            <tr>
                                ...
                                <th className='border-2 border-purple-600 rounded-md max-md:hidden'>Author</th>
                                <th className='border-2 border-purple-600 rounded-md max-md:hidden'>PublishYear</th>
